...
而 "beefed"（不含字母 "a"）以及 "based"（其中的 "s" 没有出现在谜面中）。  返回一个答案数组 answer，
...
int main(){
    vector<string> wells{"aaaa","asas","able","ability","actt","actor","access"};
    vector<string> puzzles{"aboveyz","abrodyz","abslute","absoryz","actresz","gaswxyz"};

    vector<int> num = Solution().findNumOfValidWords(wells, puzzles);
